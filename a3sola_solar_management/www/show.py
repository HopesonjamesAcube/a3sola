...
def get_context(context):
    ...
    # q="SELECT * FROM `tabFreshchat` WHERE tabFreshchat.opportunity='%s'"%(oppo[0]['name'])
    # freshchat =frappe.db.sql(q,as_dict=True)
    # print(freshchat)
    # if len(freshchat)>0:
    #     context.rsid=freshchat[0]['restore_id']
    #     context.external_id=freshchat[0]['opportunity']
